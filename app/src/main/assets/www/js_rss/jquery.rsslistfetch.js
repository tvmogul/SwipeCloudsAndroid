...
(function ($, undefined) {
    ...
    $.fn.rsslistfetch = function (params) {
        ...
        //var bodyContainer = $("<nav>"); //.attr('data-role', 'description');
        ...
        $.getJSON(feed, function (d) {
            ...
            //}); 
            //var _text = false;
            var html = '<nav data-iscroll=\'{"hScroll":false,"vScroll":true,"resizeEvents":"orientationchange","resizeWrapper":true}\' data-id="description" data-role="description"><ul data-theme="a" id="rsslistfetch-ul" data-role="listview" data-inset="false" data-filter="false" style="padding-top:20px;padding-bottom:20px;">';
            //var html = '<ol data-theme="a" id="rsslistfetch-ul" data-role="listview" data-inset="false" data-filter="false" style="padding-top:20px;padding-bottom:20px;">';

            if (_listdivider == "") {

            }
            else if (_listdivider == "ww_chest") {
                html += '<li data-role="list-divider" class="ww_chest_categories"><div id="movieheader"><img src="img_default/ww_chest_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_abdominals") {
                html += '<li data-role="list-divider" class="ww_abdominals_categories"><div id="movieheader"><img src="img_default/ww_abdominals_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_spine") {
                html += '<li data-role="list-divider" class="ww_spine_categories"><div id="movieheader"><img src="img_default/ww_spine_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_neck") {
                html += '<li data-role="list-divider" class="ww_neck_categories"><div id="movieheader"><img src="img_default/ww_neck_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_back") {
                html += '<li data-role="list-divider" class="ww_back_categories"><div id="movieheader"><img src="img_default/ww_back_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_legs") {
                html += '<li data-role="list-divider" class="ww_legs_categories"><div id="movieheader"><img src="img_default/ww_legs_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_shoulders") {
                html += '<li data-role="list-divider" class="ww_shoulders_categories"><div id="movieheader"><img src="img_default/ww_shoulders_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_arms") {
                html += '<li data-role="list-divider" class="ww_arms_categories"><div id="movieheader"><img src="img_default/ww_arms_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "ww_energy") {
                html += '<li data-role="list-divider" class="ww_energy_categories"><div id="movieheader"><img src="img_default/ww_energy_categories.png" style="padding-top: 2px !important; padding-left: 2px !important;" /></div></li>';
            }
            else if (_listdivider == "movies") {
                html += '<li data-role="list-divider" class="1_movie_categories"><div id="movieheader"><img src="img_default/1_movie_categories.png" style="padding-top: 12px !important; padding-left: 12px !important;" /></div></li>';
            }
            else if (_listdivider == "tv") {
                html += '<li data-role="list-divider" class="1_tvshow_categories"><div id="movieheader"><img src="img_default/1_tvshow_categories.png" style="padding-top: 12px !important; padding-left: 12px !important;" /></div></li>';
            }
            else if (_listdivider == "blogs") {
                html += '<li data-role="list-divider" class="1_blog_categories"><div id="movieheader"><img src="img_default/1_blog_categories.png" style="padding-top: 12px !important; padding-left: 12px !important;" /></div></li>';
            }
            else if (_listdivider == "music") {
                _text = false;
                html += '<li data-role="list-divider" class="1_music_categories"><div id="movieheader"><img src="img_default/1_music_categories.png" style="padding-top: 12px !important; padding-left: 12px !important;" /></div></li>';
            }
            else if (_listdivider == "logins") {
                html += '<li data-role="list-divider" class="ww_chest_categories"><div id="movieheader"></div></li>';
            }
            else if (_listdivider == "games") {
                _text = true;
                html += '<li data-role="list-divider" class="1_games_categories"><div id="movieheader"><img src="img_default/1_games_categories.png" style="padding-top: 12px !important; padding-left: 12px !important;" /></div></li>';
            }
            ...
            $.each(d[category], function (i, data) {
                ...
                //var link = data.link;
                //var date = new Date(data.publishedDate);
                //var text = cleanEntities(data.shortDescription);
                //var fullText = cleanEntities(data.description);
                ...
                html += '<img class="rounded-img" src="' + image + '" alt="' + title + '" data-search="' + search + '" data-id="' + link + '" data-sd="' + shortDescription + '" />';
        ...
        $(document).on('click touchend', '.rounded-img', function (e) {
            ...
            else if (category == "ww_chest") {
                /////////////////////////////////////////////////////
                //var _desc = 'We invite you to try out our CHEST Workout which we have included FREE. Just click on the CHEST icon on the previous page.'
                //store.set('ww_category', {
                //    cat: 'ww_chest'
                //});
                localStorage.setItem('videoid', link);
                localStorage.setItem('videodesc', sd);
                window.location = "./videoplayer.html";
                /////////////////////////////////////////////////////
                return false;
            }
            else if ((category == "ww_abdominals") ||
                    (category == "ww_spine") ||
                    (category == "ww_neck") ||
                    (category == "ww_back") ||
                    (category == "ww_legs") ||
                    (category == "ww_shoulders") ||
                    (category == "ww_arms") ||
                    (category == "ww_energy")) {
                /////////////////////////////////////////////////////
                var cache = new Cache(localStorage, JSON);
                if (cache.hasItem("appdata")) {
                    if (cache.getItem("appdata").authorized.length > 0) {
                        localStorage.setItem('videoid', link);
                        localStorage.setItem('videodesc', sd);
                        window.location = "./videoplayer.html";
                    }
        ...
        $(document).on('click', '.linkpopup2', function (e) {
            ...
            $("#datatest").html(feed);
            //$('#inlinedescription').simpledialog2({ 'hide': { effect: 'fadeOut', duration: 5000} });
            ShowPopup();
        });
...
//    _zauth = localStorage["authorized"];
//    if (_zauth === "1") {
//        _authorized = 1;
//    }
//} else {
