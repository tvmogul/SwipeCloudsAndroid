...
var chess = (function () {
	...
	//nDeskWidth = 354, nDeskHeight = 354, nFlatBVMargin = 2, // theese values are modificable
    nDeskWidth = 300, nDeskHeight = 300, nFlatBVMargin = 4, // theese values are modificable
    nFlatBoardSide = nDeskHeight - nFlatBVMargin, nPageX, nPageY, iBoardsBoxX, iBoardsBoxY, nDscrsX, nDscrsY, oFilm, nMinWidth = nMinHeight = 160,
    ...
    */
    ...
    function showSolidBoard() {
        if (graphicsStatus === 0) {
            ...
            XHR("chess_meshes/board.json", function () {
                if (graphicsStatus === 0) { return; }
                etc.tmp3DBoard = eval("(" + this.responseText + ")");
                runComponents();
            });
            XHR("chess_meshes/pawn.jscn", loadCom, 0);
            XHR("chess_meshes/king.jscn", loadCom, 1);
            XHR("chess_meshes/knight.jscn", loadCom, 2);
            XHR("chess_meshes/bishop.jscn", loadCom, 3);
            XHR("chess_meshes/rook.jscn", loadCom, 4);
            XHR("chess_meshes/queen.jscn", loadCom, 5);
            XHR("chess_3d/scene.jsfb", loadCom, 6);
            XHR("chess_3d/vec3.jsfb", loadCom, 7);
            XHR("chess_3d/matrix3.jsfb", loadCom, 8);
            XHR("chess_3d/camera.jsfb", loadCom, 9);
            XHR("chess_3d/mesh.jsfb", loadCom, 10);
            XHR("chess_3d/light.jsfb", loadCom, 11);
