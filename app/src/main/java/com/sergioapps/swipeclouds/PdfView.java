...
public class PdfView {
     ...
     * @param jobName name of the pdf file without the .pdf extension
     * */
    public static void createWebPrintJob(Activity activity, WebView webView,
                                         File directory, String jobName, final Callback callback) {
